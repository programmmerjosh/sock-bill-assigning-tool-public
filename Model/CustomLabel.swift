...
class CustomLabel: UILabel {
    ...
    func positionLabelFrame(xCoordinate:Int = 0, yCoordinate: Int = 0, width: Int = Int(UIViewController().view.frame.width)) -> CGRect {
        
        let labelFrame  = CGRect(x: xCoordinate, y: yCoordinate, width: width - 20, height: 30)
